...
export function WelcomeCard() {
  ...
  return (
    <section
      ...
      className="mb-6 rounded-lg border border-sky-200 bg-sky-50 p-4 text-sm text-neutral-700"
    >
      <div className="mb-2 flex items-start justify-between gap-3">
        ...
        <button
          ...
          onClick={closeCard}
          className="rounded px-2 py-0.5 text-neutral-500 hover:bg-sky-100 hover:text-neutral-700"
        >
          ✕
        </button>
      </div>
      <ul className="list-disc space-y-1 pl-5 text-sm leading-relaxed">
        <li>
          Nhập <strong className="font-semibold">Tck cơ bản</strong> của vũ khí (ví dụ BS: 0.45,
          Rante: 0.3).
        </li>
        <li>
        ...
        <li>
          <strong className="font-semibold">Enchant khác</strong>: tự động enchant các thẻ còn dư
          theo XP, CX, hoặc Cự ly.
        </li>
        <li>
        ...
        <li>
          ...
          là các mốc tròn đạn. Bấm vào nhiều ô để so sánh chi tiết cùng lúc; bấm lại để bỏ chọn.
        </li>
        <li>
          Bấm <strong className="font-semibold">+ Add build</strong> để so sánh nhiều build, và{" "}
          <strong className="font-semibold">Copy link</strong> để chia sẻ cấu hình hiện tại.
        </li>
      </ul>
